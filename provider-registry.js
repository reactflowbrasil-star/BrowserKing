(function() {
  ...
  const PROVIDERS = {
    ...
    google: {
      ...
      models: [
        createModel('gemini-3.6-flash', 'Gemini 3.6 Flash', { supportsVision: true }),
        createModel('gemini-2.5-computer-use-preview-10-2025', 'Gemini 2.5 Computer Use Preview', { supportsVision: true }),
        createModel('gemini-3.1-pro-preview', 'Gemini 3.1 Pro Preview', { supportsVision: true }),
        createModel('gemini-3.5-flash', 'Gemini 3.5 Flash', { supportsVision: true }),
        createModel('gemini-3.5-flash-lite', 'Gemini 3.5 Flash-Lite', { supportsVision: true }),
        createModel('models/gemini-3.7-flash', 'Gemini 3.7 Flash', { supportsVision: true }),
  ...
  function normalizeState(input) {
    ...
    normalized.permissionMode = 'follow_a_plan';
  ...
  function buildFeaturePayload(state, customInstructions = '') {
    const modelOptions = [];
