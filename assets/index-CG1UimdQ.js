...
*/function Tt(){if(a)return f;a=1;var r=Number.POSITIVE_INFINITY;return f=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function xt(){if(v)return s;v=1;var r=l?c:(l=1,c=Number);return s=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function Jt(){if(S)return k;S=1;var r=O?j:(O=1,j=function(r){return r!=r});return k=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function zt(){if(_r)return mr;_r=1;var r=function(){if(gr)return br;gr=1;var r=qt(),n="function"==typeof Uint32Array;return br=function(t){return n&&t instanceof Uint32Array||"[object Uint32Array]"===r(t)}}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function Kt(){if(Sr)return kr;Sr=1;var r=zt(),n=Ar?wr:(Ar=1,wr=4294967295),t=function(){if(Or)return jr;Or=1;var r="function"==typeof Uint32Array?Uint32Array:null;return jr=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function Xt(){if(Tr)return Fr;Tr=1;var r,n=function(){if(Er)return Nr;Er=1;var r=Kt();return Nr=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/(),t=function(){if(Ir)return Ur;Ir=1;var r="function"==typeof Uint32Array?Uint32Array:void 0;return Ur=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/(),e=Mr?Pr:(Mr=1,Pr=function(){throw new Error("not implemented")});return r=n()?t:e,Fr=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function Zt(){if(Jr)return Hr;Jr=1;var r=function(){if(Cr)return xr;Cr=1;var r=qt(),n="function"==typeof Float64Array;return xr=function(t){return n&&t instanceof Float64Array||"[object Float64Array]"===r(t)}}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function $t(){if(Rr)return Dr;Rr=1;var r=Zt(),n=function(){if(Lr)return Gr;Lr=1;var r="function"==typeof Float64Array?Float64Array:null;return Gr=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function re(){if(Kr)return zr;Kr=1;var r,n=function(){if(Wr)return Vr;Wr=1;var r=$t();return Vr=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/(),t=function(){if(Qr)return Br;Qr=1;var r="function"==typeof Float64Array?Float64Array:void 0;return Br=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/(),e=qr?Yr:(qr=1,Yr=function(){throw new Error("not implemented")});return r=n()?t:e,zr=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function ne(){if(rn)return $r;rn=1;var r=function(){if(Zr)return Xr;Zr=1;var r=qt(),n="function"==typeof Uint8Array;return Xr=function(t){return n&&t instanceof Uint8Array||"[object Uint8Array]"===r(t)}}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function te(){if(fn)return on;fn=1;var r=ne(),n=tn?nn:(tn=1,nn=255),t=function(){if(un)return en;un=1;var r="function"==typeof Uint8Array?Uint8Array:null;return en=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function ee(){if(dn)return yn;dn=1;var r,n=function(){if(cn)return an;cn=1;var r=te();return an=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/(),t=function(){if(sn)return ln;sn=1;var r="function"==typeof Uint8Array?Uint8Array:void 0;return ln=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/(),e=pn?vn:(pn=1,vn=function(){throw new Error("not implemented")});return r=n()?t:e,yn=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function ue(){if(mn)return gn;mn=1;var r=function(){if(bn)return hn;bn=1;var r=qt(),n="function"==typeof Uint16Array;return hn=function(t){return n&&t instanceof Uint16Array||"[object Uint16Array]"===r(t)}}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function ie(){if(kn)return On;kn=1;var r=ue(),n=wn?_n:(wn=1,_n=65535),t=function(){if(jn)return An;jn=1;var r="function"==typeof Uint16Array?Uint16Array:null;return An=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function oe(){if(Fn)return Mn;Fn=1;var r,n=function(){if(Nn)return Sn;Nn=1;var r=ie();return Sn=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/(),t=function(){if(Un)return En;Un=1;var r="function"==typeof Uint16Array?Uint16Array:void 0;return En=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function me(){if(kt)return Ot;kt=1;var r=ve(),n=jt?At:(jt=1,At=2146435072),t=Ht();return Ot=function(e){var u=r(e);return(u=(u&n)>>>20)-t|0}}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function _e(){if(Ut)return Et;Ut=1;var r=Tt(),n=Ct(),t=Ht(),e=g?b:(g=1,b=1023),u=_?m:(_=1,m=-1023),i=A?w:(A=1,w=-1074),o=Jt(),f=Gt(),a=function(){if(ct)return at;ct=1;var r=de();return at=r}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
